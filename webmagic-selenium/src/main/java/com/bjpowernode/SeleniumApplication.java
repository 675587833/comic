...
import com.bjpowernode.action.SeleniumAction;
import com.bjpowernode.downloader.SeleniumDownloader;
...
public class SeleniumApplication implements CommandLineRunner {
    ...
    public void run(String... args) throws Exception {
        ...
        Spider.create(new RoumanPageProcessor())
                ...
                .setDownloader(new SeleniumDownloader().setSleepTime(2000).setOperator(new SeleniumAction()))
