...
import com.bjpowernode.action.PuppteerAction;
import com.bjpowernode.downloader.PuppteerDownloader;
...
public class PuppteerApplication implements CommandLineRunner {

    public static void main(String[] args) {
        SpringApplication.run(PuppteerApplication.class, args);
    }
    ...
    public void run(String... args) throws Exception {
        ...
        Spider.create(new RoumanPageProcessor())
                ...
                .setDownloader(new PuppteerDownloader().setSleepTime(2000).setOperator(new PuppteerAction()))
